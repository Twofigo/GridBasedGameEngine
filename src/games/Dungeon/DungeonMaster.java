...
import games.Dungeon.Inventory.*;
import games.Dungeon.World.DungeonGenerator;
import games.Dungeon.World.Exit;
import games.Dungeon.World.Level;
import games.Dungeon.World.Wall;
...
public class DungeonMaster extends PuppetMaster {
    ...
    private void loadTextures(){
        ...
        th.addTexture("Texture/player/base/human_m.png", "human");
        th.addTexture("Texture/item/misc/gold_pile.png", "coin");
        th.addTexture("Texture/dc-mon/undead/spectral_warrior.png","zombie");

        //Consumables
        th.addTexture("Texture/item/potion/ruby.png", "hp_Pot");
        th.addTexture("Texture/item/potion/i-heal.png","hp_Effect");
        th.addTexture("Texture/item/food/orange.png","orange");
        th.addTexture("Texture/item/food/chunk.png","meat");
        th.addTexture("Texture/item/potion/orange.png","str_Pot");
        th.addTexture("Texture/item/potion/i-gain-strength.png","str_Effect");

        // equipment
        //dropped
        th.addTexture("Texture/item/armour/headgear/elven_leather_helm.png","hat2");
        th.addTexture("Texture/item/armour/elven_leather_armor.png","jacket");
        th.addTexture("Texture/item/armour/headgear/wizard_hat2.png", "hat");
        th.addTexture("Texture/item/armour/mottled_dragon_hide.png", "bikini");
        th.addTexture("Texture/item/armour/dwarven_ringmail.png", "chainmail");
        th.addTexture("Texture/player/legs/leg_armor02.png", "legs");
        th.addTexture("Texture/item/weapon/battle_axe1.png", "axe");
        th.addTexture("Texture/item/weapon/executioner_axe1.png", "axe2");
        th.addTexture("Texture/item/armour/shields/buckler1.png","shield");
        th.addTexture("Texture/item/armour/shields/shield1_elven.png","shield2");
        th.addTexture("Texture/item/weapon/quarterstaff.png","staff");
        th.addTexture("Texture/item/weapon/spear2.png","spear");
        th.addTexture("Texture/item/weapon/mace1.png","mace");
        th.addTexture("Texture/item/weapon/morningstar2.png","morningstar");
        th.addTexture("Texture/item/weapon/long_sword1.png","sword");
        th.addTexture("Texture/player/hand1/artefact/sword_of_power.png","sword2");

        //equipped
        th.addTexture("Texture/player/hand1/blessed_blade.png","sword2_eq");
        th.addTexture("Texture/player/hand1/sword3.png","sword_eq");
        th.addTexture("Texture/player/hand1/morningstar2.png","morningstar_eq");
        th.addTexture("Texture/player/hand1/mace.png","mace_eq");
        th.addTexture("Texture/player/hand1/spear1.png","spear_eq");
        th.addTexture("Texture/player/hand1/quarterstaff1.png","staff_eq");
        th.addTexture("Texture/player/hand2/shield_knight_blue.png","shield2_eq");
        th.addTexture("Texture/player/hand2/boromir.png","shield_eq");
        th.addTexture("Texture/player/body/jacket2.png","jacket_eq");
        th.addTexture("Texture/player/head/feather_green.png","hat2_eq");
        th.addTexture("Texture/player/head/wizard_purple.png", "hat_eq");
        th.addTexture("Texture/player/body/bikini_red.png", "bikini_eq");
        th.addTexture("Texture/player/body/chainmail3.png", "chainmail_eq");
        th.addTexture("Texture/player/legs/leg_armor02.png", "legs_eq");
        th.addTexture("Texture/player/hand1/axe_double.png", "axe_eq");
        th.addTexture("Texture/player/hand1/axe_executioner.png", "axe2_eq");

        // world
        /*
        th.addTexture("Texture/dc-dngn/floor/ice0.png", "Floor1");
        th.addTexture("Texture/dc-dngn/floor/ice1.png", "Floor2");
        th.addTexture("Texture/dc-dngn/floor/ice2.png", "Floor3");
        th.addTexture("Texture/dc-dngn/floor/ice3.png", "Floor4");
        */
        th.addTexture("Texture/dc-dngn/floor/grey_dirt0.png", "Floor1");
        th.addTexture("Texture/dc-dngn/floor/grey_dirt1.png", "Floor2");
        th.addTexture("Texture/dc-dngn/floor/grey_dirt2.png", "Floor3");
        th.addTexture("Texture/dc-dngn/floor/grey_dirt3.png", "Floor4");
        th.addTexture("Texture/dc-dngn/floor/grey_dirt4.png", "Floor5");
        th.addTexture("Texture/dc-dngn/floor/grey_dirt5.png", "Floor6");
        th.addTexture("Texture/dc-dngn/floor/grey_dirt6.png", "Floor7");
        th.addTexture("Texture/dc-dngn/floor/grey_dirt7.png", "Floor8");

        th.addTexture("Texture/dc-dngn/floor/dirt_full.png", "grass");
        //th.addTexture("Texture/dc-dngn/floor/floor_sand_stone5.png", "Floor6");
        //th.addTexture("Texture/dc-dngn/floor/floor_sand_stone6.png", "Floor7");
        //th.addTexture("Texture/dc-dngn/floor/floor_sand_stone7.png", "Floor8");

        th.addTexture("Texture/dc-dngn/floor/cobble_blood1.png", "Floor");

        th.addTexture("Texture/dc-dngn/wall/dngn_mirrored_wall.png", "inventory");
        th.addTexture("Texture/dc-dngn/wall/stone_brick1.png", "wall");
    }
    ...
    private ArrayList<Item> createItemList(){
        ...
        for (int i = 0; i < 2.2*Math.tanh(difficulty*0.3)+1; i++) {
            Picked.add(Items.get(new Random().nextInt(Items.size())));
        }
        for (int i = 0; i < 3.2*Math.tanh(difficulty*0.3); i++) {
